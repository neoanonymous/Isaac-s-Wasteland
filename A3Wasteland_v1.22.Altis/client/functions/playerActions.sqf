...
[
	...
	["<t color='#ff9900'>HALO jump</t>", "ATM_airdrop\atm_airdrop.sqf", [cursorTarget], 1, false, false, "", "(vehicle player == player) and (cursortarget iskindof 'FlagPole_F') and (player distance cursortarget) < 5"],  //Halo jump added, MEANY
