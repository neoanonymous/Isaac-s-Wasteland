...

{
	...
	switch (_name) do
	{
		...
		case "Backpack":  //MEANY Backpack dupe fix but sets default pack
		{
			//removeBackpack player;   //MEANY edit to try fix duplicating backpack
		...
		{
			player addBackpack "B_Carryall_ocamo"; // temporary backpack to hold mags
