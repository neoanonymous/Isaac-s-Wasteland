...
switch (_boxType) do
{
	...
	case "mission_USSpecial":
	{
		...
		[
			...
			["mag", "150Rnd_93x64_Mag", RANDOM_BETWEEN(1,5)],
			["mag", "130Rnd_338_Mag", RANDOM_BETWEEN(1,5)],
			["mag", "150Rnd_762x54_Box_Tracer", RANDOM_BETWEEN(1,5)],
			["mag", "20Rnd_762x51_Mag", RANDOM_BETWEEN(1,5)]
		];
	};
	case "mission_Main_A3snipers":
	{
		...
		[
			// Item type, Item class(es), # of items, # of magazines per weapon
			["wep", ["srifle_GM6_LRPS_F", "srifle_GM6_camo_LRPS_F","srifle_DMR_06_camo_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(4,6)],
			...
			["itm", "optic_KHS_old", RANDOM_BETWEEN(1,2)],
			["mag", "10Rnd_338_Mag", RANDOM_BETWEEN(1,3)],
			["mag", "10Rnd_762x54_Mag", RANDOM_BETWEEN(1,3)],
			["mag", "150Rnd_762x54_Box", RANDOM_BETWEEN(1,3)],
			["mag", "10Rnd_127x54_Mag", RANDOM_BETWEEN(1,3)],
			["bac", ["B_Carryall_mcamo", "B_Kitbag_mcamo"], RANDOM_BETWEEN(2,5)],
			["mag", "150Rnd_93x64_Mag", RANDOM_BETWEEN(1,3)],
			["mag", "10Rnd_93x64_DMR_05_Mag", RANDOM_BETWEEN(1,3)],
			["itm", "ItemGPS", RANDOM_BETWEEN(0,1)],
			["mag", "20Rnd_762x51_Mag", RANDOM_BETWEEN(1,3)]
		];
	};
