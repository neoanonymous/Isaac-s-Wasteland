...
_setupObjects =
{
	...
	_missionHintText = format ["TAKE COVER BOYS!! An armed <t color='%2'>%1</t> is patrolling the island. Shoot it down and kill the pilot to recover the money and weapons!", _vehicleName, extraMissionColor];
...
_successExec =
{
	...
	_Boxes1 = ["Box_East_Support_F","Box_East_Grenades_F","Box_East_WpsLaunch_F","Box_NATO_WpsSpecial_F","C_supplyCrate_F"];    
	_currBox1 = _Boxes1 call BIS_fnc_selectRandom;
	_box1 = createVehicle [_currBox1, _lastPos, [], 2, "None"];
	_box1 setDir random 360;
	_box1 allowDamage false;

	_Boxes2 = ["Box_East_Support_F","Box_East_Grenades_F","Box_East_WpsLaunch_F","Box_NATO_WpsSpecial_F","C_supplyCrate_F"];    
