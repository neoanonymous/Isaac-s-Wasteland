...
_vestTypes = ["V_PlateCarrier2_rgr","V_PlateCarrierSpec_rgr"];
_weaponTypes = ["arifle_MXC_Holo_pointer_F","LMG_Mk200_MRCO_F","arifle_MXM_DMS_F","arifle_MX_GL_Hamr_pointer_F"];
